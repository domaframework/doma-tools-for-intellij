-- Test referencing instance fields and methods of a non-Entity class
    ...
    WHERE
        ...
        /*%for <error descr="The type that can be used in the loop directive is an Iterable type">child</error> : employee.<error descr="The field or method [projectIds] does not exist in the class [EmployeeSummary]">projectIds</error> */
           -- An error occurred because the referenced element was not correctly defined.
           AND pe.parent_project = /* <error descr="The type that can be used in the loop directive is an Iterable type">child</error>.projectId */0
