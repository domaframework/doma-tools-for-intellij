...
class SqlFormattingModelBuilder : FormattingModelBuilder {
    ...
    private fun createSpaceBuilder(settings: CodeStyleSettings): SpacingBuilder =
        SpacingBuilder(settings, SqlLanguage.INSTANCE)
            ...
            .spacing(1, 1, 0, false, 0)
            .around(SqlTypes.PERCENT)
            .spacing(1, 1, 0, false, 0)
            .before(SqlTypes.FUNCTION_NAME)
            .spacing(1, 1, 0, false, 0)
            .around(SqlTypes.SEPARATOR)
            .spacing(1, 1, 0, false, 0)
            .before(SqlTypes.EL_NOT)
            .spacing(1, 1, 0, false, 0)
            .after(SqlTypes.EL_NOT)
            .spacing(0, 0, 0, false, 0)
            .around(SqlTypes.EL_AND)
            .spacing(1, 1, 0, false, 0)
            .around(SqlTypes.EL_OR)
            .spacing(1, 1, 0, false, 0)
            .around(SqlTypes.EL_EQ)
            .spacing(1, 1, 0, false, 0)
            .around(SqlTypes.GE)
            .spacing(1, 1, 0, false, 0)
            .around(SqlTypes.GT)
