...
//                SqlElOperationBlock(child, wrap, alignment, spacingBuilder)
            ...
            SqlTypes.EL_STATIC_FIELD_ACCESS_EXPR ->
                SqlElStaticFieldAccessBlock(child, wrap, alignment, createStaticFieldSpacingBuilder(), spacingBuilder)

            SqlTypes.EL_FUNCTION_CALL_EXPR ->
                SqlElFunctionCallBlock(child, wrap, alignment, createSpacingBuilder(), spacingBuilder)
