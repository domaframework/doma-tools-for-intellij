...
class ValidationMethodProcedureParamTypeResult(
    ...
    override fun setHighlight(
        ...
        holder.registerProblem(
            identify,
            MessageBundle.message("inspection.invalid.dao.procedure.params.type", annotationType.name, annotationType.requireType),
