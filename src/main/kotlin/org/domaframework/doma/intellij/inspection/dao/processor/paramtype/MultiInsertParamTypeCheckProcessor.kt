...
/**
 * Processor for checking the parameter types of DAO methods annotated with @MultiInsert.
 *
 * This class validates the parameters of DAO methods to ensure they meet the requirements
 * for methods annotated with @MultiInsert. It performs checks such as:
 ...
 */
class MultiInsertParamTypeCheckProcessor(
     ...
     * with the requirements for methods annotated with @MultiInsert.
     *
    ...
    override fun checkParams(holder: ProblemsHolder) {
        ...
        val paramIdentity = param.nameIdentifier ?: return
        val resultParamType =
